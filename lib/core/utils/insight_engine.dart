    ...
    if (extraMonthlyPayment != null &&
      ...
      insights.add(
        Insight(
          ...
          title: isEs ? 'Pago Extra Acelera tu Deuda' : 'Extra Payment Boost',
          body: isEs
    ...
    if (annualRatePct >= 15.0) {
      insights.add(
        Insight(
          ...
          title: isEs ? 'Estrategia Avalancha' : 'Avalanche Strategy',
          body: isEs
    ...
    if (monthsToPayoff > 0 && monthsToPayoff < 24) {
      insights.add(
        Insight(
          ...
          title: isEs ? '¡Casi Libre de Deuda!' : 'Almost Debt-Free!',
          body: isEs
      ...
      insights.add(
        Insight(
          ...
          title: isEs ? 'Ritmo Constante' : 'Steady Progress',
          body: isEs
