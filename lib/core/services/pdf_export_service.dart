  ...
  static Future<void> exportPayoff({
    ...
    pdf.addPage(pw.Page(
      ...
      build: (_) => _buildPage(
        ...
        monthlyPayment: monthlyPayment, extraPayment: extraPayment,
        monthsToPayoff: monthsToPayoff, totalInterest: totalInterest,
    ...
    await Printing.sharePdf(
      ...
      filename: 'LoanPayoff_${balance.round()}_${DateTime.now().millisecondsSinceEpoch}.pdf',
    );
  }

  static pw.Widget _buildPage({
    required double balance, required double rate,
    required double monthlyPayment, required double extraPayment,
    required int monthsToPayoff, required double totalInterest,
    required double interestSaved, required int monthsSaved,
    required String strategy,
  }) {
    ...
    return pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
      pw.Row(mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
        ...
        children: [
          pw.Column(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
            pw.Text('Loan Payoff Calculator',
                style: pw.TextStyle(fontSize: 20, fontWeight: pw.FontWeight.bold, color: _purple)),
            pw.Text('Debt Payoff Strategy Report',
                style: const pw.TextStyle(fontSize: 11, color: PdfColors.grey700)),
          ]),
          pw.Text(_date.format(now),
              style: const pw.TextStyle(fontSize: 9, color: PdfColors.grey600)),
        ]),
      pw.Container(height: 2, color: _purple, margin: const pw.EdgeInsets.only(top: 6, bottom: 14)),
      ...
      pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.start, children: [
        pw.Expanded(child: pw.Column(children: [
          _sectionBox('LOAN DETAILS', [
            ...
            if (extraPayment > 0)
              _row2('Extra Payment',   _cur2.format(extraPayment), bold: true, color: _purple),
        ...
        pw.Expanded(child: pw.Column(children: [
          _sectionBox('PAYOFF RESULTS', [
            _row2('Months to Pay Off', '$monthsToPayoff mo (${(monthsToPayoff / 12.0).toStringAsFixed(1)} yr)'),
            _row2('Total Interest',    _cur0.format(totalInterest)),
            pw.Divider(color: PdfColors.grey300, height: 6),
            _row2('Interest Saved',    _cur0.format(interestSaved), bold: true, color: _purple),
      ...
      pw.Column(children: [
        ...
        pw.Text('Generated by Loan Payoff Calculator · For illustration purposes only. Not financial advice.',
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        SizedBox(width: double.infinity, child: ElevatedButton.icon(
          ...
          style: ElevatedButton.styleFrom(
              backgroundColor: AppTheme.accentGood, foregroundColor: Colors.white,
